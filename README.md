...
You changed the save content in TSS: overwrite save xxx with it, then `./build.sh` and reload the save.

In addition to the step above, you could have `./listen.sh` running in another terminal to print the output of TSS (especially usefull for translating error message source locations).
