...
I18N.locales.en = {
    ...
    smugglingUp = "%s got %s from Smuggling and advances their Freighter.",
    smugglingDown = "%s got %s from Smuggling and brought their Freighter to the base.",
    ...
    commercialDownUp = " brought their freighter back to base and then drove it away.",
    commercialUp = " advances their freighter on the commercial track.",
    commercialDown = " brought their freighter back to base.",
...
I18N.locales.fr = {
    ...
    smugglingUp = "%s a obtenu %s de la Contrebande et avance son Freighter.",
    smugglingDown = "%s a obtenu %s de la Contrebande et rappelle son Freighter à la base.",
    ...
    commercialUpUp = " avance deux fois son freighter sur la Piste commerciale.",
    commercialUpDown = " avance son freighter sur la Piste commerciale et le fait rentrer à la base.",
    commercialDownUp = " fait rentrer son freighter à la base puis le fait repartir.",
    commercialUp = " avance son freighter sur la Piste commerciale.",
    commercialDown = " fait rentrer son freighter à la base.",
