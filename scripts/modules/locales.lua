i18n.locales.en = {
    ...
    acquireChamurkyTechBenefits = "%s got 2 Intrigues by buying this Technology.",
    ...
    firstSnooperRecall = "Tessia Vernius has recalled her first snooper from the Faction %s.",
    secondSnooperRecall = "Tessia Vernius has recalled her second snooper from the Faction %s.",
    thirdSnooperRecall = "Tessia Vernius has recalled her third snooper from the Faction %s.",
    fourthSnooperRecall = "Tessia Vernius has recalled her fourth snooper from the Faction %s.",
    firstSnooperRecallEffectInfo = "Having recalled you first snooper, you may discard a card to get 1 spice."
}
...
i18n.locales.fr = {
    ...
    acquireChamurkyTechBenefits = "%s a gagné 2 Intrigues en achetant cette Technologie.",
    ...
    firstSnooperRecall = "Tessia Vernius a rappelé son premier fouineur de la Faction %s.",
    secondSnooperRecall = "Tessia Vernius a rappelé son second fouineur de la Faction %s.",
    thirdSnooperRecall = "Tessia Vernius a rappelé son troisième fouineur de la Faction %s.",
    fourthSnooperRecall = "Tessia Vernius a rappelé son quatrième fouineur de la Faction %s.",
    firstSnooperRecallEffectInfo = "Ayant rappelé votre premier fouineur, vous pouvez défausser une carte pour gagne 1 Épice."
}
