return {
    ...
    judgeOfTheChangeAbility = "↯ Liet Kynes s’octroie la part de l’Empereur.",
    arrakisPlanetologistAbility = "↯ Lite Kynes trouve des babioles dans le sable.",
    ...
    corruptBureaucrat = "Bureaucrate corrompu",
    mercantileAffairs = "Affaires mercantile",
    choamDemands = "Exigence de la CHOM",
    ...
    falseOrders = "Faux ordres",
    graspArrakis = "Saisir Arrakis",
    insiderInformation = "Information privilégiée",
    ripplesInTheSand = "Ondulations sur le sable",
    sleeperUnit = "Unité dormante",
    ...
    stormsInTheSouth = "Tempêtes dans le sud",
    ...
    forbiddenWeapons = "Armes interdites",
    advancedDataAnalysis = "Analyse de données avancée",
    ornithopterFleet = "Flotte d’ornis",
    panopticon = "Panoptique",
    spyDrones = "Drones espions",
    choamTransports = "Transports de la CHOM",
