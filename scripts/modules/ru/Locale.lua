return {
    ...
    leaderSelectionExclude = "Вы можете Удалите (или переверните) любого лидера, которого хотите исключить.\nКогда будете удовлетворены, нажмите кнопку «Старт».",
    start = "Старт",
