...
local Deck = {
    ...
    imperium = {
        legacy = {
            ...
            otherMemory = 1,
            lietKynes = 1,
            wormRiders = 2, -- Not the 2024 WSBG Dune: Imperium tournament bonus (alternate artwork + foiled finish)
        ...
        uprising = {
            ...
            theBeastSpoils = 1, -- Dune: Imperium prerelease tournament bonus
            smugglerHaven = 1,
            shishakli = 1,
            paracompass = 1,
            ...
            stilgarTheDevoted = 1,
            desertPower = 1,
            arrakisRevolt = 1, -- Dune: Imperium – Uprising preorder bonus
            priceIsNoObject = 1,
        ...
        bloodlines = {
            ...
            pointingTheWay = 1,
            shroudedCounsel = 1,
            ruthlessLeadership = 1, -- Dune: Imperium – Bloodlines preorder bonus
            pivotalGambit = 1, -- 2025 WSBG Dune: Imperium tournament bonus
        },
        bloodlinesContract = {
            deliveryLogistics = 2,
            corruptBureaucrat = 1,
