    ...
    for _, color in ipairs({ "Green", "Yellow", "Blue", "Red", "White", "Purple" }) do
        ...
        local decals = {
            ...
            },
            {
                ...
                url = "http://cloud-3.steamusercontent.com/ugc/2488878371134017159/52C4F6DEBC5F101B6663B833F1964BB9034A7C75/",
            ...
            },
            {
                ...
                url = "http://cloud-3.steamusercontent.com/ugc/2488878371134016948/D455406509BD5D1C4387C102CBACC5BFB56FC59E/",
            ...
            },
            {
                ...
                url = "http://cloud-3.steamusercontent.com/ugc/2488878371134017299/E4E692FE0EF6AF7B51B5A31DAC5D0D7DC7859655/",
...
function PlayBoard.acceptTurn(phase, color)
    ...
    elseif phase == 'combat' then
        Helper.dumpFunction("color = ", color)
        Helper.dump("PlayBoard.combatPassCountdown =", PlayBoard.combatPassCountdown)
        Helper.dump("Combat.isInCombat =", Combat.isInCombat(color))
        Helper.dump("#PlayBoard._getPotentialCombatIntrigues =", #PlayBoard._getPotentialCombatIntrigues(color))
